package com.MSVC_EduTech.Curso.exceptions;
...
public class GlobalExceptionHandler {
    ...
    private ResponseEntity<ErrorDTO> handleCursoException(CursoException exception){
        ...
        if(exception.getMessage().contains("no se encuentra en la base de datos")) {
            ...
            Map<String, String> errorMap = Collections.singletonMap("Curso existente", exception.getMessage());
